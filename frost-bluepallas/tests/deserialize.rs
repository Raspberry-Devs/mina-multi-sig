...
fn serialize_field_element() {
    ...
    assert_eq!(
        ...
        "Deserialized element should match original"
    );
}

// TODO: Ensure that if two elements have different serialized but are the same modulo the field, they are considered equal.
